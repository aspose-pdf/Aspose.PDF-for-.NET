<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditorControl.ascx.cs" Inherits="Aspose.App.UI.ProductTools.Pdf.EditorControl" %>

<!-- Modal -->
<div class="modal" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="fileUploadDialogLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" id="fileUploadDialogLabel">File Upload Dialog</h4>
            </div>
...
<div class="modal" id="moveModal" tabindex="-1" role="dialog" aria-labelledby="H1" aria-hidden="true" data-backdrop="static" data-keyboard="false">
...
<div class="modal" id="replaceModal" tabindex="-1" role="dialog" aria-labelledby="H2" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Attachments -->
<div class="modal" id="divAttach" tabindex="-1" role="dialog" aria-labelledby="H3" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
...
<div class="well well-sm">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><a onclick="newFileClick('upload')">Create New File</a></li>
            <li><a class="open-uploadModal" data-toggle="modal" data-target="#uploadModal" data-id="uploading" data-placement="top" title="Upload File to Server">Open From Computer</a></li>
        </ul>
    </div>
    ...
    <button class="open-moveModal btn btn-default btn-lg" data-toggle="modal" data-target="#moveModal" onclick="moveClick(event)" data-id="moving" id="btnMoving" data-placement="top" title="Move Page" disabled="disabled">
        <span class="glyphicon glyphicon-transfer"></span>
    </button>

    <button class="open-uploadModal btn btn-default btn-lg" data-toggle="modal" data-target="#uploadModal" onclick="appendClick(event)" data-id="appending" id="btnAppending" data-placement="top" title="Append File" disabled="disabled">
        <span class="glyphicon glyphicon-plus-sign"></span>
    </button>

    <button onclick="javascript:GeneralSetup('Save');SavePdf();return false;" class="btn btn-default btn-lg" id="btnSave" data-toggle="tooltip" data-placement="top" title="Save Pdf File" disabled="disabled">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            <li><a onclick="javascript:ExportFile('pdf');return false;">As PDF File</a></li>
            <li><a onclick="javascript:ExportFile('docx');return false;">As Word File </a></li>
            <li><a onclick="javascript:ExportFile('xls');return false;">As Excel File </a></li>
            <li><a onclick="javascript:ExportFile('txt');return false;">As Text File </a></li>
            <li><a onclick="javascript:ExportFile('svg');return false;">As SVG File </a></li>
            <li><a onclick="javascript:ExportFile('xps');return false;">As XPS File </a></li>
            <li><a onclick="javascript:ExportFile('html');return false;">As HTML File </a></li>
        </ul>
    </div>
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li><a onclick="clearSearchClicked()">Clear Search</a></li>
        </ul>
    </div>

    <button type="button" class="btn btn-default btn-lg dropdown-toggle open-uploadModal" data-toggle="modal" data-target="#uploadModal" data-id="images" data-placement="top" title="Insert Image"
        aria-expanded="false" onclick="GeneralSetup('Image');" id="btnImage" disabled="disabled">
        <span class="glyphicon glyphicon-picture"></span>
    </button>

    <div class="btn-group">
        <button id="btnRect" value="rect" class="btn btn-default btn-lg" data-toggle="buttons-radio" data-placement="top" title="Highlight Mode" onclick="GeneralSetup('Rect');" disabled="disabled">
            <span class="glyphicon glyphicon-header"></span>
        </button>

        <button id="btnRead" value="reading" class="btn btn-default btn-lg" data-toggle="buttons-radio" data-placement="top" title="Read Mode" onclick="GeneralSetup('Read');" disabled="disabled">
            <span class="glyphicon glyphicon-hand-up"></span>
        </button>

        <button id="btnDrag" value="dragging" class="btn btn-default btn-lg" data-toggle="buttons-radio" data-placement="top" title="Drag Mode" onclick="GeneralSetup('Drag');" disabled="disabled">
            <span class="glyphicon glyphicon-move"></span>
        </button>

        <button id="btnTexting" value="texting" class="btn btn-default btn-lg" data-toggle="buttons-radio" data-placement="top" title="Text Mode" onclick="GeneralSetup('Text');" disabled="disabled">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><a class="open-uploadModal" data-toggle="modal" data-target="#uploadModal" data-id="addAttachment" data-placement="top" title="Add Attachment">Add Attachment</a></li>
