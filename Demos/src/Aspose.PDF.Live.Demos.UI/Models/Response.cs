...
namespace Aspose.Pdf.Live.Demos.UI.Models
{
	...
	public class Response
	{
		...
		public override string ToString()
		{
			...
			int _fileProcessingErrorCode = (int)Enum.Parse(typeof(Aspose.Pdf.Live.Demos.UI.Models.FileProcessingErrorCode), FileProcessingErrorCode.ToString());
			return $"{StatusCode}|{FileName}|{FolderName}|{_fileProcessingErrorCode}|{Status}";
		}
