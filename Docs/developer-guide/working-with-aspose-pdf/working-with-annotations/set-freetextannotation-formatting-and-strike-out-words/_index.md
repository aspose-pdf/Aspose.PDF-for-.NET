...
[Add Annotation in an Existing PDF File](/pdf/net/add-delete-and-get-annotation/) explained how to add annotations to a file. This topic looks at how to format the text in a free text annotation.
