...
Aspose.PDF allows you to [split a PDF into individual pages](/pdf/net/manipulate-page-in-a-pdf-file-html/) and save them as PDF files. Getting a specified page in a PDF file and saving it as a new PDF is a very similar operation: open the source document, access the page, create a new document and add the page to this.
