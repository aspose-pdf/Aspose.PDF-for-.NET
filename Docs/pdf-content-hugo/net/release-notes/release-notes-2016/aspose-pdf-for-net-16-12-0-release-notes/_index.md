...
|PDFNET-41687|When PDF is converted to HTML, the resulting HTML file has long scrollbars in Microsoft Edge|Bug|
|PDFNET-41680|When PDF document is converted to XPS, the second page shows "This page cannot be displayed" message|Bug|
...
|PDFNET-41714|When PDF converted to PDF_A_1B, the document has glyphs missing in embedded fonts error|Bug|
