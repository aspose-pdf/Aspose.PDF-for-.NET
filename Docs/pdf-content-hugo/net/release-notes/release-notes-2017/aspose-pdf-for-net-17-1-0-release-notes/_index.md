...
|PDFNET-41735|doc.Pages[1](/pages/createpage.action?spaceKey=pdfnet&title=1&linkCreation=true&fromPageId=22546067).Resources.Images.Names and doc.Pages[1](/pages/createpage.action?spaceKey=pdfnet&title=1&linkCreation=true&fromPageId=22546067).Resources.Images[0](/pages/createpage.action?spaceKey=pdfnet&title=0&linkCreation=true&fromPageId=22546067).Name returns different names for same image.|Bug|
